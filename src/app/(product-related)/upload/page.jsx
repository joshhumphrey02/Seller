...
import Specs from "@/components/uploads/Specs";
      ...
      <div className=" sub_main">
        ...
        <div className=" sub">
          <form
            ref={formRef}
            autoComplete="off"
            className="bg_primary shadow-md px-1 pt-2 pb-3"
            onSubmit={(e) => {
            ...
            <div className="form-con grid lg:grid-cols-2 md:grid-cols-1 gap-2">
                ...
                <div>
                  ...
                  <div className="flex flex-col gap-2 my-3">
                    <div className="border-2 px-2 rounded-md border_color">
                      ...
                      <input
                        type="text"
                        className="w-full bg_primary h-6"
                        name="name"
                        autoComplete="off"
                        autoCapitalize="on"
                        id="name"
                ...
                <div>
                  ...
                  <div className="my-2 images">
                    ...
                    <div className="my-2 flex imagesDiv flex-col gap-2">
                      <div className="border-2 Div px-1 rounded-md border_color">
                        <input
                          type="file"
                          name="image"
                          className="w-full bg_primary h-8 mt-1"
                          id="image"
                          accept="img/*"
                          required
                        />
                ...
                <div>
                  ...
                  <div className="features">
                    ...
                    <div className="mt-2 flex featuresDiv flex-col gap-2">
                      <div className="border-2 Div px-2 rounded-md border_color">
                        <input
                          type="text"
                          className="w-full bg_primary h-8"
                          name="price"
                          id="price"
                          required
                        />
              ...
              <div>
                <div>
                  ...
                  <div className="border-2 mt-3 px-1 flex rounded-md border_color">
                    <textarea
                      name="description"
                      id="description"
                      required
                      className="w-full bg_primary mt-1"
                      cols="70"
                      rows="10"
                    ></textarea>
                  </div>
